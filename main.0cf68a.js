        ...
        var l = function(e) {
          ...
          y = e.BJ_REPORT = {
            ...
            init: function(e) {
              ...
              return r && (/qq\.com$/gi.test(location.hostname) && (o.url || (o.url = "//badjs2.qq.com/badjs"), o.uin || (o.uin = parseInt((document.cookie.match(/\buin=\D+(\d+)/) || [])[1], 10))), o.report = (o.url || "/badjs") + "?id=" + r + "&uin=" + o.uin + "&"),
              t.length && v(),
                y
            },
...
// // if ($(".instagram").length) {
//   require(['/js/photos.js'], function (obj) {
//     debugger;
//     obj.init();
//   });
// // }
